  ...
  `,
        ...
        <motion.div
            ...
            <div
                ...
                style={{
                background:"linear-gradient(90deg,#D7A23F 0%,rgba(215,162,63,.35) 40%,transparent 100%)"
                }}
                />
...
/>
        ...
        >
            <div className="max-w-[650px] text-center">
                ...
                >
                From modern workplaces to industrial landmarks —
                we design and build spaces that drive productivity,
            ...
            >
                ...
                <motion.a
                    ...
                    style={{
                    background:
                        "linear-gradient(90deg,#EA8C18 0%,#F3BE4C 100%)",
                    boxShadow:
                        "0 18px 45px rgba(234,140,24,.35)",
                    }}
                >
